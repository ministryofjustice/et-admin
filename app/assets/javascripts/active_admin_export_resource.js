$(document).ready(function() {
    $('a.active-admin-export-resource').on('click', function(event){
        var message;
    ...
    $('a.active-admin-export-resource').on('confirm:complete', function(event, inputs){
        var href, form, hiddenInput;
        formData = Object.assign({}, inputs);
        formData.resource_id = $(this).attr('data-resource-id');
        formData.resource_type = $(this).attr('data-resource-type');
